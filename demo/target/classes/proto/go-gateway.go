...
import (
	...
	"github.com/OmarU38/midterm-mod-4-IRS-8vo/object_detection" // Reemplaza con la ruta correcta del paquete generado
...
func (s *greenObjectServer) PublishObjectCoordinates(ctx context.Context, empty *object_detection.Empty) (*object_detection.ObjectCoordinates, error) {
	...
	coordinates := &object_detection.ObjectCoordinates{
		X:         0.0, // Reemplaza con las coordenadas correctas
		Y:         0.0, // Reemplaza con las coordenadas correctas
		Timestamp: 0.0, // Reemplaza con la marca de tiempo correcta
	}
